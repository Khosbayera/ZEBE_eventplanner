...
import { MongolianBand, MongolianDivider, OrnamentDot } from "./components/MongolianOrnament";
...
export default function App() {
  ...
  const goToPlanner = () => setSection("planner");
      ...
      {section === "home" && (
        <>
          ...
          >
            <span
              className="font-cinzel text-gold-shimmer"
              style={{ fontSize: 18, letterSpacing: "0.25em", fontWeight: 700 }}
            >
              ZEBE
            </span>
            <div className="flex gap-2">
              <button className="tab-btn" onClick={goToPlanner}>
                AI Planner
              </button>
              <button className="tab-btn" onClick={() => setSection("explorer")}>
                Services
              </button>
            </div>
          </div>
